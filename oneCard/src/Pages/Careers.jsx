        ...
        <div>
          <div className="flex flex-col gap-10">
            <div className="w-4/5 text-center m-auto">
              <h1 className="text-6xl font-extrabold font-serif">
                Careers at <span className="text-[#0093f7]">OneCard</span>
              </h1>
            </div>
            <div className="w-4/5 m-auto">
              <p className="w-3/5 m-auto text-lg font-serif">
            ...
            <div className="w-4/5 m-auto">
              <div className="w-4/5 border-2 rounded-xl  m-auto">
                <img
          ...
          <div>
            ...
            <div className="mt-20 pt-10">
              <div className="w-3/5 m-auto text-center shadow-2xl mt-10  py-10">
                <div className=" flex  items-center w-4/5 m-auto justify-center border-b-2 border-black  h-40">
