      ...
      <div className="w-4/5 m-auto mb-14">
        <div className="flex p-1 gap-2 flex-wrap ">
          <div className="p-2 ">
            ...
            {/* <br /> */}
            <div>
              <p className="text-center py-3 font-semibold text-base">
          ...
          <div className="p-2">
            <div className="rounded-full shadow-2xl m-auto w-fit p-3">
              <img
                className="w-14"
                src="https://www.getonecard.app/images/icons/culture___credit_card.png"
                alt=""
              />
            </div>
            {/* <br /> */}
          ...
          <div className="p-2">
            <div className="rounded-full shadow-2xl w-fit m-auto p-3 ">
              <img
                className="w-14"
                src="https://getonecard.app/images/icons/onecard_features.png"
                alt=""
              />
            </div>
            {/* <br /> */}
          ...
          <div className="p-2">
            <div className="rounded-full shadow-2xl w-fit p-3 m-auto ">
              <img
                className="w-14"
                src="https://www.getonecard.app/images/icons/repayments___emi.png"
                alt=""
              />
            </div>
            {/* <br /> */}
          ...
          <div className="p-2">
            <div className="rounded-full shadow-2xl w-fit p-3 m-auto ">
              <img
                className="w-14"
                src="https://www.getonecard.app/images/icons/security.png"
                alt=""
              />
            </div>
            {/* <br /> */}
